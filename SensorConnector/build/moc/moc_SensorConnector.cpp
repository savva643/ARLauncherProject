...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSensorConnectorSCOPESensorConnectorCoreENDCLASS_t qt_meta_stringdata_CLASSSensorConnectorSCOPESensorConnectorCoreENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(67, 17),  // "statisticsUpdated"
        QT_MOC_LITERAL(85, 15),  // "ConnectionStats"
        QT_MOC_LITERAL(101, 5),  // "stats"
        QT_MOC_LITERAL(107, 23),  // "connectionStatusChanged"
        QT_MOC_LITERAL(131, 6),  // "status"
        QT_MOC_LITERAL(138, 19),  // "clientsCountChanged"
        QT_MOC_LITERAL(158, 5)   // "count"
    },
    "SensorConnector::SensorConnectorCore",
    "dataReceived",
    "",
...
void SensorConnector::SensorConnectorCore::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->statisticsUpdated((*reinterpret_cast< std::add_pointer_t<ConnectionStats>>(_a[1]))); break;
        case 2: _t->connectionStatusChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 3: _t->clientsCountChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
