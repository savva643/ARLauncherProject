...
// Примечание: glDrawArrays, glDrawElements, glActiveTexture уже объявлены в GL/gl.h, не переопределяем
...
static bool LoadOpenGLFunctions() {
    ...
    // glDrawArrays, glDrawElements, glActiveTexture уже доступны из GL/gl.h
